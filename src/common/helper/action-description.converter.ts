const ACTION_DESCRIPTIONS = {
	...
	'product-storehouse/one-createOneProductStorehouse-post': `Bitta mahsulotni omborga qo'shish`,
	'product-storehouse/one-deleteOneProductStorehouse-delete': `Bitta mahsulotni ombordan o'chirish`,
