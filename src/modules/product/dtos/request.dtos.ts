...
export class ProductCreateOneRequestDto
	extends IntersectionType(PickType(ProductRequiredDto, ['name', 'cost', 'price', 'quantity', 'warningThreshold']))
	implements ProductCreateOneRequest {}

export class ProductUpdateOneRequestDto
	extends IntersectionType(PickType(ProductOptionalDto, ['name', 'cost', 'price', 'quantity', 'warningThreshold']))
