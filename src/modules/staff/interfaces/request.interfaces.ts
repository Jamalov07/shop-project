...
//body
export declare interface StaffCreateOneRequest extends Pick<StaffRequired, 'phone' | 'password'>, Pick<StaffOptional, 'fullname'>, Pick<RequestOtherFields, 'actionsToConnect'> {}
